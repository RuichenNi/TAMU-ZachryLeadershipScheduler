...
# @schedule_to_course = Course.create!(subject_id: @subject.id, abbreviated_subject: "NUEN", course_number: 301, section_number: 500, term_id: @term.id, meetingtime_start: DateTime.new(2001,2,3,9,45,6,'-05:00'), meetingtime_end: DateTime.new(2001,2,3,11,00,6,'-05:00'), meeting_days: ['T','TR']).save